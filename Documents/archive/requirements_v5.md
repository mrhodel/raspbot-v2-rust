...
## Requirements Specification — Version 1.4 (V5)
...
- **Deterministic robotics:** perception, localization, mapping, planning, control, calibration, executive behavior management, and safety
...
# 14. Message Bus / Runtime Communication
...
# 16. HAL Scheduling and Priority Policy
...
6. camera + event-driven depth pipeline
7. pseudo-lidar extraction
8. telemetry / replay system
9. micro-SLAM prototype
10. occupancy mapping from pseudo-lidar + pose
11. classical frontier detection + baseline heuristics
12. planner + controller
13. fast simulator
14. RL frontier selector
15. real robot integration
16. sim-to-real tuning

---

# 21. Expected Capabilities
